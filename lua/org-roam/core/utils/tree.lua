...
---
---@class org-roam.core.utils.IntervalTree
---@field data any
...
---@field left? org-roam.core.utils.IntervalTree
---@field right? org-roam.core.utils.IntervalTree
local M = {}
M.__index = M
...
---@param data any
---@return org-roam.core.utils.IntervalTree
...
---
---@param a org-roam.core.utils.IntervalTree
...
---@alias org-roam.core.utils.tree.MatchFn fun(node:org-roam.core.utils.IntervalTree, start:integer|nil, end_:integer|nil):boolean

---@class org-roam.core.utils.tree.FindOpts
...
---@field match? "c"|"contains"|"i"|"intersects"|org-roam.core.utils.tree.MatchFn
...
function M:find_all(opts)
    ...
    if opts.match == "c" or opts.match == "contains" then
        ---@param node org-roam.core.utils.IntervalTree
        ---@param i integer|nil
        ---@param j integer|nil
        ---@return boolean
