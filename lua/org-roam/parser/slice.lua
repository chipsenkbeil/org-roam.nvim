...
---@field private __full org-roam.parser.Ref<string> #reference to full text
---@field private __cache string #cache to the text represented by this slice
---@field private __range org-roam.parser.Range
local M = {}
M.__index = M
...
---@param ref org-roam.parser.Ref<string>
---@return org-roam.parser.Slice
...
---@return org-roam.parser.Position
