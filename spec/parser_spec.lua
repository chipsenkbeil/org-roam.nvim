...
describe("Parser", function()
  ...
  it("should parse an org file correctly", function()
    ...
    assert.equals(40, output.drawers[1].properties[1].name:start_byte_offset())
    assert.equals(2, output.drawers[1].properties[1].name:end_row())
    assert.equals(3, output.drawers[1].properties[1].name:end_column())
    assert.equals(41, output.drawers[1].properties[1].name:end_byte_offset())
    ...
    assert.equals(0, output.drawers[1].properties[2].name:start_column())
    assert.equals(50, output.drawers[1].properties[2].name:start_byte_offset())
