...
describe("Parser", function()
  ...
  it("should parse an org file correctly", function()
    ...
    assert.equals(2, output.drawers[1].properties[1].key:start_row())
    assert.equals(1, output.drawers[1].properties[1].key:start_column())
    assert.equals(40, output.drawers[1].properties[1].key:start_byte_offset())
    assert.equals(2, output.drawers[1].properties[1].key:end_row())
    assert.equals(3, output.drawers[1].properties[1].key:end_column())
    assert.equals(41, output.drawers[1].properties[1].key:end_byte_offset())
    ...
    assert.equals(3, output.drawers[1].properties[2].key:start_row())
    assert.equals(0, output.drawers[1].properties[2].key:start_column())
    assert.equals(50, output.drawers[1].properties[2].key:start_byte_offset())
