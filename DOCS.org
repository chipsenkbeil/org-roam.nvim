...
** OrgRoamInitialized
   ...
   Triggered when the plugin is fully initialized, including the database.
   ...
   vim.api.nvim_create_autocmd("User", {
     ...
     callback = function()
       vim.print("org roam initialized") -- Print initialized
     end,
   })
   #+end_src
...
** OrgRoamNodeEnter
   ...
   Triggered when entering a buffer or moving a cursor to an org roam node.

   The =data= argument of the autocmd's callback will be set to the node.
   ...
   vim.api.nvim_create_autocmd("User", {
     ...
     callback = function(args)
       vim.print(args.data) -- Print node entered
     end,
   })
   #+end_src
...
** OrgRoamNodeLeave
   ...
   Triggered when leaving a buffer or moving a cursor away from an org roam
   node. Note that this is only triggered when leaving one node for another.
   ...
   vim.api.nvim_create_autocmd("User", {
     ...
     callback = function(args)
       vim.print(args.data) -- Print node left
     end,
   })
   #+end_src
